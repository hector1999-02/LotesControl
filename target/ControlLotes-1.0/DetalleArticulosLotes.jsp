...
<html>
    ...
    <body>
        ...
        <!--Tabla para editar los registros--> 
        <div align="center">
        ...
        //                                        boolean tieneRegistro = true;
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center acciones">
                                            <!-- Agrega un botón o enlace que redirija a la página de actualización -->
                                            <form id="miFormulario2" action="BuscarProductoServlet" method="GET">
                                                <input type="hidden" name="item_id" value="<%= art1m.getItemId()%>">       
        ...
        //                                        boolean tieneRegistro = true;
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center acciones">
                                            <!-- Agrega un botón o enlace que redirija a la página de actualización -->
                                            <form id="miFormulario2" action="BuscarProductoServlet" method="GET">
                                                <input type="hidden" name="item_id" value="<%= art6m.getItemId()%>">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center acciones">
                                            ...
                                            <div>
                                                ...
                                                <div  class="col-auto">
                                                    <form id="miFormulario2" action="BuscarProductoServlet" method="GET">
                                                        <input type="hidden" name="item_id" value="<%= art8m.getItemId()%>">

...
<html>
    ...
    <body class="d-flex align-items-center justify-content-center" style="height: 100vh;">
        ...
        <div class="text-center mx-auto">
            ...
            <form action="MostrarReporteProducto" method="POST">
                <!-- Luego cambiar a hidden -->
                <input type="hidden" name="id" value="<%= rs.getInt("id") %>">
                <input type="hidden" name="codigo_farmacia" value="<%= rs.getString("farmaciaId") %>">
                <input type="hidden" name="nombre_farmacia" value="<%= rs.getString("farmaciaName") %>">
                <button type="submit" class="btn btn-info btn-lg mt-4" style="transition: background-color 0.3s;">Ver Productos y Lotes</button> 
            </form>
            <% 
